package com.cannyquest.participants.acquiring.common;
...
public class transformDHItoSVFE extends QBeanSupport implements TransactionParticipant, Configurable {
    ...
    private ISOMsg transformer(ISOMsg msg) throws ISOException, InvalidCardException {
        ...
        if(msg.hasField(43)){
            svfeMsg.set(43,transformMERCHANT_NAME(msg.getString(43)));
        }

        transformMERCHANT_NAMEDE(msg, svfeMsg);
        ...
        if (msg.hasField(52))
            svfeMsg.set(52,transformPINBLOCK(msg.getBytes(52)));

        //transformPINBLOCK(msg, svfeMsg);

        if (msg.hasField(55)){
            svfeMsg.set(55,transformCHIP_DATA(msg.getBytes(55)));
        }

        //transformCHIP_DATA(msg, svfeMsg);

        return svfeMsg;
    }

    public static String transformMERCHANT_NAME(String merchant_name) {
        String name = merchant_name.substring(0,25);
        String street = " ";
        String city = merchant_name.substring(25,38);
        String state = " ";
        String country = "IRQ";
        String postal_code = " ";
        String separator = "\u003E";

        return name+separator+street+separator+city+separator+separator+country+separator;
    }

    public static String transformPINBLOCK(byte[] bytes) {
    ...
    public static byte[] transformCHIP_DATA(byte[] bytes) {
    ...
    public static void transformCHIP_DATA(ISOMsg msg, ISOMsg svfeMsg) {
        if (msg.hasField(55)){
            TLVList de55 = new TLVList();
    ...
    public static void transformPINBLOCK(ISOMsg msg, ISOMsg svfeMsg) {
        if(msg.hasField(52)){
    ...
    public static void transformMERCHANT_NAMEDE(ISOMsg msg, ISOMsg svfeMsg) {
        if(msg.hasField(43)){
